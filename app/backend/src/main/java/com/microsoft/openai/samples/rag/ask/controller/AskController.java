...
/**
 * Controller providing the api for one shot ask to the RAG model.The APPLICATION_NDJSON_VALUE based
 * API is used for streaming the response. Streaming works only with RAG implementation based on
 * plain java Open AI client sdk. Semantic Kernel doesn't support streaming yet
 */
@RestController
